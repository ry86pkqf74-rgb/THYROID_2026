...
The legacy `any_recurrence_flag` (n=503) and `structural_recurrence_flag` (n=1,819) in the cohort view do not match the canonical resolution. Of the 503 legacy any-recurrence cases, 318 have `recurrence_status_final='none'` and no canonical evidence; of the 1,819 structural-flag cases, 1,467 have `recurrence_status_final='none'` and no canonical evidence. The legacy flags are reported in S2 sensitivity only.
...
|---|---:|---:|---:|---:|
| Microscopic ETE | 1.1% (10/947) | 2.7% (19/712) | 2.3% (15/642) | 5.6% (15/269) |
| Gross ETE | 2.6% (7/268) | 4.1% (13/318) | 7.0% (24/344) | 8.6% (29/336) |
| No/negative ETE | 3.8% (2/52) | 11.4% (5/44) | 7.0% (3/43) | 3.8% (2/53) |

Notes. Six microscopic-ETE rows have unknown size and are excluded. The microscopic ETE >4 cm cell (5.6%) is the highest microscopic-ETE recurrence rate in any size stratum; this is consistent with prior literature reporting that mETE prognostic effect strengthens in larger tumors.

### Supplement Table S2 — Recurrence endpoint comparison (sensitivity)

| ETE group | Path-proven n | Composite n | Legacy any_recurrence n | Cohort-view structural n |
|---|---:|---:|---:|---:|
| Microscopic ETE | 59 | 145 | 267 | 1,168 |
| Gross ETE | 73 | 163 | 203 | 583 |
| No/negative ETE | 12 | 29 | 28 | 51 |
| Present ungraded | 1 | 1 | 2 | 11 |
| Missing/other | 0 | 2 | 3 | 4 |
| **Total** | 145 | 340 | 503 | 1,819 |
...
|---|---:|---:|---:|---:|---:|
| Microscopic ETE | 1,584 | 8,137 | 0.71 | 1.74 | 3.00 |
| Gross ETE | 972 | 4,138 | 1.76 | 3.92 | 3.22 |
| No/negative ETE | 118 | 701 | 1.71 | 4.00 | 3.18 |
...
Within the 3,212 patients with non-missing surgery date in 1999–2024, the gross-vs-microscopic ETE contrast on path-proven recurrence is preserved. Detailed counts available in `M044_ETE_analysis.sql` query 8.
...
**S3.4 Endpoint sensitivity.** The legacy `any_recurrence_flag` model produces inflated event counts (n=503 vs path-proven n=145). The gross-vs-microscopic OR is smaller under the legacy flag (consistent with legacy-flag noise diluting the contrast). The structural-recurrence-flag is not used in any analysis.
...
| recurrence_path_proven | `canonical_recurrence_resolved_v1` | binary | Pathology-proven recurrence (PRIMARY) |
