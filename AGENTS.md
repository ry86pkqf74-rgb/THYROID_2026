...
- Streamlit QA dashboard falsely reports >800 patients "missing age/race/gender" because cross-file DOB/race/gender matching was incomplete; every patient has DOB in at least one raw Excel file; this is a display bug in dashboard.py not a data gap
