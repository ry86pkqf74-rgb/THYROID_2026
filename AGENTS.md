...
- RLN injury data landscape: 10,864 complication rows total; `rln_injury_or_vocal_cord_paralysis_vocal_cord_palsy` field: 1,314 = 'x' (placeholder), 24 = 'yes' (chart-documented), 1 = '?'; `vocal_cord_status`: 8 paresis/paralysis (all have laryngoscopy dates), 41 unknown, rest NULL; only 48 patients have any laryngoscopy_date; old crude filter counted 1,340 (including 'x' placeholders), new postop view = 6
- Among 24 chart-documented RLN patients: 7 overlap with vocal_cord_status paresis/paralysis; 17 have vocal_cord_status='unknown' + affected_side documented — potential Tier 2 expansion candidates
- Dashboard Complications tab: uses `vw_confirmed_postop_rln_injury` when available (KPI: "Confirmed Postop RLN Injury — N patients (X% of surgical cohort)"), falls back to crude text-matching labeled "(crude)" when view absent
