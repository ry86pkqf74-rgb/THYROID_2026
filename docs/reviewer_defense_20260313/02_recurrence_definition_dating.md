...
- **Structured source**: `recurrence_risk_features_mv` (local DuckDB, 4,976 rows, 3,986 unique patients)
- **Refined recurrence table**: `extracted_recurrence_refined_v1` (local DuckDB, 10,871 rows)
