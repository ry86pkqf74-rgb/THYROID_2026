...
- **NLP refinement pipeline**: `llm_extraction/complications_refined_pipeline.py`, `llm_extraction/rln_refined_pipeline.py`
- **Molecular FP correction**: `llm_extraction/extraction_audit_engine_v9.py` (Phase 11)
- **Complication refinement audit**: `extracted_complications_exclusion_audit_v2` (local DuckDB)
- **Source reliability scores**: `llm_extraction/extraction_audit_engine_v4.py` (Phase 5 source hierarchy)
- **Validation table**: `val_complication_refinement` (local DuckDB, per-entity raw vs refined counts)
- **Overall data quality report**: `llm_extraction/phase8_final_report.md` (96/100 composite score)
