...
Self-contained PSM replay on current `exports/*.csv`. Outputs are **not** the manuscript primary; they document reproducibility vs [`../../../studies/proposal2_ete_staging/audit_tables/table6_propensity_matching_effect.csv`](../../../studies/proposal2_ete_staging/audit_tables/table6_propensity_matching_effect.csv).
