...
Usage:
    python -m llm_extraction.extraction_audit_engine --all --md
    python -m llm_extraction.extraction_audit_engine --entity hypocalcemia --md
    python -m llm_extraction.extraction_audit_engine --inventory-only --md
"""
