...
| File | Location |
|------|----------|
| Variable inventory + prioritization matrix | `llm_extraction/variable_inventory_phase4.md` |
| Source-aware audit engine | `llm_extraction/extraction_audit_engine_v2.py` |
| ETE LLM judge prompt | `prompts/ete_v1.txt` |
| ETE NLP classified samples | `llm_extraction/audit_ete_nlp_classified.parquet` |
| ETE source-by-source audit report | `llm_extraction/audit_v2_ete.md` |
