...
Usage:
    from llm_extraction.extraction_audit_engine_v2 import audit_and_refine_by_source
    results = audit_and_refine_by_source("ete", con, sample_size=250)

CLI:
    .venv/bin/python llm_extraction/extraction_audit_engine_v2.py \
...
from llm_extraction.extraction_audit_engine import (
    EntityClassifier,
    AuditResult,
