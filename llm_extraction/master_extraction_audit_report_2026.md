...
| File | Purpose |
|------|---------|
| `llm_extraction/extraction_audit_engine.py` | Generalized audit engine (heuristic + pattern-based) |
| `llm_extraction/complications_refined_pipeline.py` | SQL deployment pipeline for all 6 entities |
| `llm_extraction/extraction_inventory_2026.md` | Full ranked entity inventory |
| `llm_extraction/extraction_inventory_2026.csv` | Machine-readable inventory |
| `llm_extraction/run_full_audit_and_refine.py` | One-command runner |
| `llm_extraction/master_extraction_audit_report_2026.md` | This file |
| `llm_extraction/complications_refinement_manifest.json` | Deployment manifest |
| `llm_extraction/missed_data_sweep_2026.parquet` | Missed-event sweep results |
| `llm_extraction/audit_*.md` | Per-entity audit reports |
