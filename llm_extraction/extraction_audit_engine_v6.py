...
Usage:
    from llm_extraction.extraction_audit_engine_v6 import audit_and_refine_phase8
    results = audit_and_refine_phase8(con)

CLI:
    .venv/bin/python llm_extraction/extraction_audit_engine_v6.py --md --variable all
"""
