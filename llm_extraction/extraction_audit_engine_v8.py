...
Usage:
    from llm_extraction.extraction_audit_engine_v8 import audit_and_refine_phase10
    results = audit_and_refine_phase10(con)

CLI:
    .venv/bin/python llm_extraction/extraction_audit_engine_v8.py --md --variable all
"""
