...
Usage:
    from llm_extraction.extraction_audit_engine_v4 import audit_and_refine_phase6
    results = audit_and_refine_phase6(con)

CLI:
    .venv/bin/python llm_extraction/extraction_audit_engine_v4.py --md --variable all
"""
