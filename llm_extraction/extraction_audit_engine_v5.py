...
Usage:
    from llm_extraction.extraction_audit_engine_v5 import audit_and_refine_phase7
    results = audit_and_refine_phase7(con)

CLI:
    .venv/bin/python llm_extraction/extraction_audit_engine_v5.py --md --variable all
"""
...
from llm_extraction.extraction_audit_engine_v4 import (
    _extract_table_name,
)
...
def main():
    ...
    parser.add_argument("--output-dir", default="llm_extraction")
