...
Usage:
    .venv/bin/python llm_extraction/variable_inventory_phase4.py [--md] [--local] [--dry-run]

Outputs:
    llm_extraction/variable_inventory_phase4.md
"""
...
def main():
    ...
    out = PROJECT_ROOT / "llm_extraction" / "variable_inventory_phase4.md"
    write_markdown_report(results, out)

    # Also save JSON for downstream consumption
    json_out = PROJECT_ROOT / "llm_extraction" / "variable_inventory_phase4.json"
