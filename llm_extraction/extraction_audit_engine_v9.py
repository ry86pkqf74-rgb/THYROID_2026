...
Usage:
    from llm_extraction.extraction_audit_engine_v9 import audit_and_refine_phase11
    results = audit_and_refine_phase11(con)

CLI:
    .venv/bin/python llm_extraction/extraction_audit_engine_v9.py --md --variable all
"""
...
def main():
    ...
    parser.add_argument("--output-dir", default="llm_extraction", help="Report output dir")
