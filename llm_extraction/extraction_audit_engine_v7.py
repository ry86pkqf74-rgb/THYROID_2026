...
Usage:
    from llm_extraction.extraction_audit_engine_v7 import audit_and_refine_phase9
    results = audit_and_refine_phase9(con)

CLI:
    .venv/bin/python llm_extraction/extraction_audit_engine_v7.py --md --variable all
"""
