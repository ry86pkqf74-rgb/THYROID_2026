#!/usr/bin/env python3
# ARCHIVED 2026-04-16: This script ran against the pre-eras consolidation DBs
# (thyroid_ete_fix_20260413 + "Thyroid 2026"). The canonical produced here was
# superseded by 221_eras_canonical_sync.py which produced canonical_patient_master_v221
# on the eras account (basis for thyroid_canonical_publication_v1_0).
