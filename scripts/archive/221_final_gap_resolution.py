#!/usr/bin/env python3
# ARCHIVED 2026-04-16: This script ran NSQIP + parathyroid gap resolution against
# thyroid_ete_fix_20260413 (pre-eras pipeline). Superseded by 221b_final_gap_resolution.py
# which applied the same fixes in the eras pipeline context.
