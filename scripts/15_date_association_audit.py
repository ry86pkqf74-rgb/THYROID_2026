...
Run after 09b_local DuckDB_upload_notes_entities.py.
"""
...
def main() -> None:
    ...
    section("SQL VIEW DEFINITIONS (for local DuckDB deployment)")
    ...
    with open(sql_output_path, "w") as f:
        ...
        f.write("-- Deploy to thyroid_master.duckdb via: USE thyroid_master.duckdb;\n\n")
