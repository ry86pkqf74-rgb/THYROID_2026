...
def check_core_missingness(con) -> str:
    ...
    key_cols = [
        ...
        # imaging-tirads-best column removed 2026-04-21 (CPM TIRADS Part B); canonical TIRADS lives on canonical_us_patient_master_VIEW_v2 now.
...
def check_imaging_limitations(con) -> str:
    ...
    if tbl_ok(con, tbl_r):
        df = q(con, f"""
            SELECT
                COUNT(*) AS total,
                -- imaging-tirads-best column removed 2026-04-21 (CPM TIRADS Part B); canonical TIRADS rollup lives on canonical_us_patient_master_VIEW_v2.max_tirads_category_ever
