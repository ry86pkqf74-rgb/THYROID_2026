...
BENCHMARK_QUERIES = [
    ...
    ("dash_date_rescue_rate",
     "dashboard_overview",
     "SELECT overall_rescue_rate_pct FROM date_rescue_rate_summary LIMIT 1",
     1, 3_000),
    ...
    ("metric_03_molecular_tested",
     "manuscript_metric",
     "SELECT COUNT(DISTINCT research_id) FROM molecular_test_episode_v2 WHERE is_placeholder_row IS NOT TRUE",
     700, 5_000),
    ...
    ("metric_06_braf_positive",
     "manuscript_metric",
     "SELECT COUNT(DISTINCT research_id) FROM extracted_braf_recovery_v1 WHERE braf_recovered_status_v11='positive'",
     400, 8_000),
