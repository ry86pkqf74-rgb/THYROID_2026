## Table 3. Cox Proportional Hazards Regression for Time to Recurrence

*N=5,794 patients with valid follow-up; 36 recurrence events.*

| Variable      | Model        | HR (95% CI)        | p-value   | Significance   |
|:--------------|:-------------|:-------------------|:----------|:---------------|
