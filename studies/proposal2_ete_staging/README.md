...
- **`../../manuscripts/ete_ajcc8_202603/MANUSCRIPT_REVISION_PACKET_20260326.md`** — Audit-first manuscript revision support (freeze, CT/node reconciliation, Methods prose, numeric checklist). **GitHub is source of truth** for this packet; refresh the Zenodo archive (new version) to mirror it—see `docs/ZENODO_GITHUB_SYNC_NOTES_20260326.md`.
- **`../../manuscripts/ete_ajcc8_202603/revision_rerun_20260326/`** — PSM sensitivity rerun on current exports (does not overwrite `audit_tables/`); local `.venv/` is gitignored.
