...
**Run label:** `targeted_3domain`  
**Generated at:** `2026-04-03T14:21:20.628318+00:00`  
**Overall verdict:** `FAIL` (2 of 8 gates failed)
...
cat studies/v2_domain_promotion_gate_targeted_3domain/promotion_scorecard.csv

# 2. (MotherDuck) Promote v2_stage -> main
# Review and paste: studies/v2_domain_promotion_gate_targeted_3domain/motherduck_promote.sql
