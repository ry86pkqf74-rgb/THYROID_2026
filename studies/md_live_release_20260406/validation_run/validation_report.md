...
**Generated:** 2026-04-07T04:01:42.076334+00:00
**Mode:** Structural Validation
**Total checks:** 15
**Passed:** 15  |  **Warned:** 0  |  **Failed:** 0
...
| Review queue | PASS | 11,244 total, 5,622 reviewed, 5,622 pending |
| QA view promotion_scorecard_summary_v | PASS | 5 rows |
| QA view domain_validation_summary_v | PASS | 5 rows |
| QA view date_provenance_completeness_v | PASS | 23 rows |
| QA view manual_review_queue_summary_v | PASS | 27 rows |
| Load inventory | PASS | 90 entries, all match |
