...
**Generated:** 2026-04-07T15:57:01.200642+00:00
**Mode:** Release Validation
**Total checks:** 31
**Passed:** 29  |  **Warned:** 2  |  **Failed:** 0

**VERDICT: PASS WITH WARNINGS** — 2 check(s) warned; no failures.
...
| Release schemas | PASS | 7 found: release_20260406, release_20260407, release_20260407_final, release_20260407_final2, release_20260407_tier, release_20260408, release_20260409 |
...
| Molecular results contract row parity | PASS | 2 live rows in contract view |
| Molecular result_id uniqueness | PASS | 2 rows; distinct molecular_result_id |
| Molecular contract non-empty | PASS | 2 contract rows |
| Molecular payload_checksum uniqueness | PASS | 2 non-null checksums; all distinct |
| Molecular provenance (results) | PASS | 2 rows; lineage_id + ingestion_ts present |
| Molecular allele_fraction bounds | PASS | 4 variant rows; AF in [0,1] or NULL |
| Molecular variant_class enum | PASS | all variant_class values in {SNV,INDEL,FUSION,CNV,OTHER} |
| Molecular assay/panel_version pairing | WARN | 1 rows with assay_name but empty panel_version |
