-- Live counts: Thyroid 2026.v2_stage.note_entities_llm_complications_rln_laryngoscopy
SELECT
  COUNT(*) AS row_count,
...
FROM "Thyroid 2026"."v2_stage"."note_entities_llm_complications_rln_laryngoscopy";
