-- Live counts: Thyroid 2026.v2_stage.note_entities_llm_synoptic_pathology_enrichment
SELECT
  COUNT(*) AS row_count,
...
FROM "Thyroid 2026"."v2_stage"."note_entities_llm_synoptic_pathology_enrichment";
