...
**Generated:** 2026-04-14T03:14:07.556823+00:00
**Mode:** Release Validation
**Total checks:** 45
**Passed:** 40  |  **Warned:** 5  |  **Failed:** 0

**VERDICT: PASS WITH WARNINGS** — 5 check(s) warned; no failures.
...
| Check | Status | Detail |
|-------|--------|--------|
| MD attachment | PASS | 14 databases attached |
| Row count parity | PASS | 23 domains checked, all match |
| Canonical canonical_extracted_fact_long_v2 | PASS | local=55,500  md=55,500 |
| Canonical canonical_fact_quarantine_v2 | PASS | local=199  md=199 |
| Canonical note_extraction_runs | WARN | local parquet absent (processed/note_extraction_runs.parquet); md=3 — export parity not checked |
...
| Canonical dist (canonical_extracted_fact_long_v2) | PASS | 574 domains, 55,500 total rows |
...
| Promotion decision provenance | PASS | 6 row(s); all have non-empty decision_batch_id |
...
| Load inventory | PASS | 270 entries, all match |
| Release schemas | PASS | 12 found: release_20260406, release_20260407, release_20260407_final, release_20260407_final2, release_20260407_tier, release_20260408, release_20260408r2, release_20260408r3, release_20260408r4, release_20260409, release_20260410, release_20260411 |
| Release manifest | PASS | 12 release(s); latest: 20260408r4 (2026-04-08 08:56:49.086697) |
| Canonical extraction_run_id | PASS | 55,500 rows; 0 blank (contract §3) |
| Presentation master_fact_long_verified_v1 | PASS | 55,500 rows; core traceability non-null (reviewer_status may be NULL) |
| Presentation master_source_lineage_v1 | PASS | 55,500 rows; core traceability non-null (reviewer_status may be NULL) |
| Presentation master_patient_rollup_verified_v1 | PASS | 5,141 patient rows; research_id + release_tag + review metrics present |
| Verified layer: canonical vs master_fact row count | PASS | 55,500 rows |
| Verified layer: lineage vs master_fact row count | PASS | 55,500 rows |
| Verified layer: rollup vs distinct research_id | PASS | 5,141 patient rows |
| Verified layer: fact_id uniqueness | PASS | 55,500 distinct fact_id |
| Verified layer: duplicate natural-key groups | WARN | 542 groups with >1 row — see docs/final_source_of_truth_contract.md (may be legitimate multi-entity/lab grain) |
| Verified layer: release_tag vs qa.release_manifest | PASS | release_tag `20260411` matches latest qa.release_manifest |
...
| Specimen/FHIR QA diagnostics (142 surfaces + focus metrics) | PASS | clean |
| Specimen-adjacent review burden (open/pending) | WARN | genomic_link_review open/pending=10155; specimen_merge_review open/pending=1 |
...
| canonical_extracted_fact_long_v2 | procedure | 3 | 2 |
...
| canonical_extracted_fact_long_v2 | medication | 1 | 1 |
...
| canonical_extracted_fact_long_v2 | nerve_monitoring | 1 | 1 |
