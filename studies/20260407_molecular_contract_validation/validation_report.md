# MotherDuck Formalization Structural Validation Report

**Generated:** 2026-04-07T06:22:14.034954+00:00
**Mode:** Structural Validation
**Total checks:** 28
**Passed:** 26  |  **Warned:** 2  |  **Failed:** 0
...
| Check | Status | Detail |
|-------|--------|--------|
| MD attachment | PASS | 8 databases attached |
...
| Molecular assay_name dictionary match | WARN | 2 distinct assay_name value(s) not in molecular_assay_dictionary (expected for non-afirma panels such as ThyroSeq) |
