...
**Generated:** 2026-04-07T02:40:18.746475+00:00
**Mode:** Release Validation
**Total checks:** 16
**Passed:** 15  |  **Warned:** 1  |  **Failed:** 0

**VERDICT: PASS WITH WARNINGS** — 1 check(s) warned; no failures.
...
| Schema completeness | WARN | 23 issues: note_entities_llm_imaging: missing ['entity_type', 'entity_value_raw', 'entity_value_norm'] (v2_stage also lacks these — wide/JSON v2 parquet shape on MD; long-form entities are in main.canonical_extracted_fact_long_v2; see docs/domain_mapping_rules.md and promotion gate JSON expansion); note_entities_llm_tirads_granular: missing ['entity_type', 'entity_value_raw', 'entity_value_norm'] (v2_stage also lacks these — wide/JSON v2 parquet shape on MD; long-form entities are in main.canonical_extracted_fact_long_v2; see docs/domain_mapping_rules.md and promotion gate JSON expansion); note_entities_llm_us_nodule_dynamics: missing ['entity_type', 'entity_value_raw', 'entity_value_norm'] (v2_stage also lacks these — wide/JSON v2 parquet shape on MD; long-form entities are in main.canonical_extracted_fact_long_v2; see docs/domain_mapping_rules.md and promotion gate JSON expansion); note_entities_llm_labs: missing ['entity_type', 'entity_value_raw', 'entity_value_norm'] (v2_stage also lacks these — wide/JSON v2 parquet shape on MD; long-form entities are in main.canonical_extracted_fact_long_v2; see docs/domain_mapping_rules.md and promotion gate JSON expansion); note_entities_llm_tg_kinetics: missing ['entity_type', 'entity_value_raw', 'entity_value_norm'] (v2_stage also lacks these — wide/JSON v2 parquet shape on MD; long-form entities are in main.canonical_extracted_fact_long_v2; see docs/domain_mapping_rules.md and promotion gate JSON expansion) |
...
| QA view promotion_scorecard_summary_v | PASS | 4 rows |
| QA view domain_validation_summary_v | PASS | 4 rows |
| QA view date_provenance_completeness_v | PASS | 23 rows |
| QA view manual_review_queue_summary_v | PASS | 6 rows |
| Load inventory | PASS | 60 entries, all match |
| Release schemas | PASS | 3 found: release_20260407, release_20260408, release_20260409 |
| Release manifest | PASS | 3 release(s); latest: 20260409 (2026-04-07 02:05:07.189573) |
