...
# Cells captured 2026-05-09 (CORRECTED 2026-05-09 post-mig_323 platform reclassification)
# from canonical_molecular_genetics_v2 post-mig_323 (platform reclassification + Afirma rescue).
# Afirma n increased: ThyroSeq-mislabeled rows now correctly classified as Afirma.
# ThyroSeq not-classifiable n decreased: removed Afirma rows from ThyroSeq cohort.
# SQL: sql/04b_table3_v2_actual_reported_call.sql run 2026-05-09 post-mig_323.
