...
forest_rows = [
    ...
    ("Afirma — B3+B4 all sizes (n=76)", 89.4, 77.4, 95.4, 17.2, 7.6, 34.5,
     63.6, 51.6, 74.2, 50.0, 23.7, 76.3, 76),
    ("Afirma — B3+B4 2–4 cm (n=4)", 75.0, 30.1, 95.4, None, None, None,
     100.0, 43.8, 100.0, 0.0, 0.0, 79.3, 4),
    ("ThyroSeq — B3+B4 all sizes (n=104)", 67.3, 53.4, 78.8, 61.8, 48.6, 73.5,
     61.1, 47.8, 73.0, 68.0, 54.2, 79.2, 104),
    ("ThyroSeq — B3+B4 2–4 cm (n=19)", 88.9, 56.5, 98.0, 90.0, 59.6, 98.2,
     88.9, 56.5, 98.0, 90.0, 59.6, 98.2, 19),
]
...
rom_rows = [
    ...
    ("negative", "benign",     29, 3.4,  3,  3,  3),
    ("negative", "malignant",  14, 7.5,  3,  3,  3),
    ("intermediate", "benign",  8, 48.1, 50, 40, 50),
    ("intermediate", "malignant", 7, 57.9, 50, 40, 70),
    ("positive", "benign",     17, 67.9, 70, 60, 70),
    ("positive", "malignant",  31, 72.8, 70, 70, 70),
]
