# Working reference list — 2026-03-26 (ScholarGPT reconciliation)

**Purpose:** Transparent bibliography for `manuscript_submission_v1.md`. **Do not** copy unverified secondary details into the final `.docx` unless confirmed from PubMed or the journal.

**Rule:** Unresolved entries must be completed from primary sources. Never invent DOIs, page ranges, or article numbers.
...
## 2) Verified references (manuscript 7–10) — reconciled 2026-03-27 (PubMed/PMC complete 2026-03-26)
...
## 3) Removed / not used in manuscript (active citation list)

- **Kim MH, et al.** (*J Endocr Surg*., 2–4 cm management). Former in-text ref **[4]** — **removed** from manuscript narrative and formal numbered list after reconciliation.
- **Conroy PC, et al.** (*Surgery* 2022 lobectomy/ATA guidelines). Former working-file ref **[8]** — **replaced** by Sutton *Am J Surg* 2022 (manuscript ref **[8]**) after verified quartet reconciliation; do not cite Conroy in this packet unless restored deliberately.
- **Placeholder “completion thyroidectomy systematic review”** (Grok / *Clin Endocrinol (Oxf)* working title, former ref **[12]**). **Removed** from formal reference list; **do not cite** in manuscript. Replace with verified sources if completion rates are discussed quantitatively in future versions.

---

## 4) Not used in manuscript v20260326 (optional background)

- Xu J, et al. Lobectomy sufficiency for 1–4 cm differentiated thyroid cancer. *Sci Rep*. 2024. doi:10.1038/s41598-024-83893-4. **Omitted** from in-text citations to avoid importing **oncologic outcome** framing; add only if editors request broader 1–4 cm context **and** wording stays non–outcome for this study.

- Barbaro D, et al. Total thyroidectomy vs lobectomy in differentiated thyroid cancer: narrative review. **NEEDS AUTHOR CHECK** (journal/volume per prior Grok memo). **Omitted** from main text to limit reference count; optional Discussion expansion.

---

## 5) Software (add if journal requires)

- **NEEDS AUTHOR CHECK:** Seabold S, Perktold J. Statsmodels: econometric and statistical modeling with Python. *Proceedings Python Sci Conf*. 2010. (or current statsmodels citation per journal); SciPy / NumPy project citations per journal policy.
