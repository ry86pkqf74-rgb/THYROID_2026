...
| **Dropped from this package** | `fig_completion_rates.png` (no visible data—**do not** submit). `fig_molecular_result_by_extent.png` (tiny cell sizes; **not** a performance figure). `fig_platform_specific_extent.png` (**overlapping** x-labels). |
...
- [ ] All **NEEDS AUTHOR CHECK** references resolved  
