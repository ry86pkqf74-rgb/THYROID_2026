...
**Generated:** 2026-04-08T16:18:14.309159+00:00
**Mode:** Release Validation
**Total checks:** 39
**Passed:** 33  |  **Warned:** 6  |  **Failed:** 0

**VERDICT: PASS WITH WARNINGS** — 6 check(s) warned; no failures.
...
| Canonical canonical_extracted_fact_long_v2 | WARN | local parquet absent (processed/canonical_extracted_fact_long_v2.parquet); md=20,188 — export parity not checked |
| Canonical canonical_fact_quarantine_v2 | WARN | local parquet absent (processed/canonical_fact_quarantine_v2.parquet); md=103,588 — export parity not checked |
