...
**Generated:** 2026-04-07T01:28:18.905004+00:00
**Mode:** Release Validation
**Total checks:** 16
**Passed:** 14  |  **Warned:** 1  |  **Failed:** 1
...
| Schema completeness | WARN | 23 issues: note_entities_llm_imaging: missing ['entity_type', 'entity_value_raw', 'entity_value_norm']; note_entities_llm_tirads_granular: missing ['entity_type', 'entity_value_raw', 'entity_value_norm']; note_entities_llm_us_nodule_dynamics: missing ['entity_type', 'entity_value_raw', 'entity_value_norm']; note_entities_llm_labs: missing ['entity_type', 'entity_value_raw', 'entity_value_norm']; note_entities_llm_tg_kinetics: missing ['entity_type', 'entity_value_raw', 'entity_value_norm'] |
...
| Review queue | FAIL | 5,622 total, 0 reviewed, 5,622 PENDING — must be resolved before release |
| QA view promotion_scorecard_summary_v | PASS | 3 rows |
| QA view domain_validation_summary_v | PASS | 3 rows |
| QA view date_provenance_completeness_v | PASS | 23 rows |
| QA view manual_review_queue_summary_v | PASS | 6 rows |
| Load inventory | PASS | 30 entries, all match |
| Release schemas | PASS | 1 found: release_20260407 |
| Release manifest | PASS | 1 release(s); latest: 20260407 (2026-04-07 01:09:57.717289) |
