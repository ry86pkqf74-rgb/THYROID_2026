...
| File | Change |
|------|--------|
| `.github/workflows/ci.yml` | RO smoke → `manuscript_cohort_v1`; `motherduck-formalization.needs` + `data-contract-gate-offline`; 145 CLI smoke step; workflow `env` `FORCE_JAVASCRIPT_ACTIONS_TO_NODE24`; header comment |
