...
**Generated:** 2026-04-07T19:23:31.097981+00:00
**Mode:** Release Validation
**Total checks:** 28
**Passed:** 25  |  **Warned:** 1  |  **Failed:** 2

**VERDICT: BLOCKED** — 2 check(s) failed.
...
| Review queue | PASS | 11,244 total, 11,244 reviewed, 0 pending |
...
| QA view manual_review_queue_summary_v | PASS | 42 rows |
...
| Release manifest | PASS | 9 release(s); latest: 20260411 (2026-04-07 19:15:39.106720) |
...
| Molecular row counts | FAIL | main.molecular_results is empty but molecular_test_episode_v2 has 10,126 rows — governed ThyroSeq/Afirma ingest not deployed on this catalog (run scripts/131_molecular_results_layer.py --execute --md, scripts/117_md_contract_views.py --md --contract-views-only, then 41_ingest_thyroseq_excel.py and 42_ingest_afirma.py with approved inputs). Contract view checks skipped. |
...
| Specimen-adjacent review burden (open/pending) | WARN | genomic_link_review open/pending=9966; specimen_merge_review open/pending=1 |
