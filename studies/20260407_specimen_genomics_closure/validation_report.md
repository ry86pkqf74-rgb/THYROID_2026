...
**Generated:** 2026-04-07T19:54:09.636958+00:00
**Mode:** Release Validation
**Total checks:** 28
**Passed:** 26  |  **Warned:** 1  |  **Failed:** 1
...
| Molecular row counts | FAIL | main.molecular_results is empty but molecular_test_episode_v2 has 10,862 rows — governed ThyroSeq/Afirma ingest not deployed on this catalog (run scripts/131_molecular_results_layer.py --execute --md, scripts/117_md_contract_views.py --md --contract-views-only, then 41_ingest_thyroseq_excel.py and 42_ingest_afirma.py with approved inputs). Contract view checks skipped. |
