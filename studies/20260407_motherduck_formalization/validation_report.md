...
**Generated:** 2026-04-07T00:11:55.845103+00:00
**Total checks:** 15
**Passed:** 10  |  **Warned:** 5  |  **Failed:** 0
...
| Check | Status | Detail |
|-------|--------|--------|
| MD attachment | WARN | No md: path in database_list (may be local-only) |
| Row count parity | WARN | 23 mismatches: note_entities_llm_imaging, note_entities_llm_tirads_granular, note_entities_llm_us_nodule_dynamics, note_entities_llm_labs, note_entities_llm_tg_kinetics, note_entities_llm_pathology, note_entities_llm_synoptic_pathology_enrichment, note_entities_llm_rai_detailed, note_entities_llm_rad_treatment, note_entities_llm_parathyroid_detail, note_entities_llm_recurrence, note_entities_llm_survival_followup, note_entities_llm_cervical_ln_detail, note_entities_llm_functional_outcomes, note_entities_llm_past_medical_hx, note_entities_llm_past_surgical_hx, note_entities_llm_presenting_symptoms, note_entities_llm_physical_exam, note_entities_llm_vascular_invasion, note_entities_llm_airway_invasion, note_entities_llm_frozen_section_detail, note_entities_llm_dynamic_risk_response, note_entities_llm_patient_decision_adherence |
...
| Schema completeness | WARN | 23 issues: note_entities_llm_imaging: missing ['entity_type', 'entity_value_raw', 'entity_value_norm']; note_entities_llm_tirads_granular: missing ['research_id', 'note_row_id', 'entity_type', 'entity_value_raw', 'entity_value_norm']; note_entities_llm_us_nodule_dynamics: missing ['research_id', 'note_row_id', 'entity_type', 'entity_value_raw', 'entity_value_norm']; note_entities_llm_labs: missing ['research_id', 'note_row_id', 'entity_type', 'entity_value_raw', 'entity_value_norm']; note_entities_llm_tg_kinetics: missing ['entity_type', 'entity_value_raw', 'entity_value_norm'] |
...
| Review queue | PASS | 5,622 total, 0 reviewed, 5,622 pending |
| QA view promotion_scorecard_summary_v | PASS | 1 rows |
| QA view domain_validation_summary_v | PASS | 1 rows |
| QA view date_provenance_completeness_v | PASS | 23 rows |
| QA view manual_review_queue_summary_v | PASS | 6 rows |
| Load inventory | WARN | Not found: Catalog Error: Table with name load_inventory does not exist!
Did you mean "qa.domain_validation_summary_v"?

LINE 1: SELECT COUNT(*) FROM v2_stage.load_inventory
                             ^ |
| Release schemas | WARN | No release_YYYYMMDD schemas found (run 115 to create). Current schemas: main, qa |
...
|--------|------|------:|--------:|-----:|:-----------:|:----------:|
| imaging | note_entities_llm_imaging | 11,037 | -1 | 11,037 | N | Y |
| tirads_granular | note_entities_llm_tirads_granular | 11,037 | -1 | -1 | N | N |
| us_nodule_dynamics | note_entities_llm_us_nodule_dynamics | 11,037 | -1 | -1 | N | N |
| labs | note_entities_llm_labs | 11,037 | -1 | -1 | N | N |
| tg_kinetics | note_entities_llm_tg_kinetics | 11,037 | -1 | 11,037 | N | Y |
| pathology | note_entities_llm_pathology | 11,037 | -1 | 11,037 | N | Y |
| synoptic_pathology_enrichment | note_entities_llm_synoptic_pathology_enrichment | 11,037 | -1 | -1 | N | N |
| rai_detailed | note_entities_llm_rai_detailed | 11,037 | -1 | -1 | N | N |
| rad_treatment | note_entities_llm_rad_treatment | 11,037 | -1 | -1 | N | N |
| parathyroid_detail | note_entities_llm_parathyroid_detail | 11,037 | -1 | -1 | N | N |
| recurrence | note_entities_llm_recurrence | 11,037 | -1 | -1 | N | N |
| survival_followup | note_entities_llm_survival_followup | 11,037 | -1 | -1 | N | N |
| cervical_ln_detail | note_entities_llm_cervical_ln_detail | 11,037 | -1 | -1 | N | N |
| functional_outcomes | note_entities_llm_functional_outcomes | 11,037 | -1 | -1 | N | N |
| past_medical_hx | note_entities_llm_past_medical_hx | 11,037 | -1 | -1 | N | N |
| past_surgical_hx | note_entities_llm_past_surgical_hx | 11,037 | -1 | -1 | N | N |
| presenting_symptoms | note_entities_llm_presenting_symptoms | 11,037 | -1 | -1 | N | N |
| physical_exam | note_entities_llm_physical_exam | 11,037 | -1 | -1 | N | N |
| vascular_invasion | note_entities_llm_vascular_invasion | 11,037 | -1 | -1 | N | N |
| airway_invasion | note_entities_llm_airway_invasion | 11,037 | -1 | -1 | N | N |
| frozen_section_detail | note_entities_llm_frozen_section_detail | 11,037 | -1 | -1 | N | N |
| dynamic_risk_response | note_entities_llm_dynamic_risk_response | 11,037 | -1 | -1 | N | N |
| patient_decision_adherence | note_entities_llm_patient_decision_adherence | 11,037 | -1 | -1 | N | N |
