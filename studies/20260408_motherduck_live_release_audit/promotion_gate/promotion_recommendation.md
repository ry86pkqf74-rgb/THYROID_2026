...
**Run label:** `promote_20260408_0407`  
**Generated at:** `2026-04-08T08:09:47.752675+00:00`  
...
| G7 | Unresolved discordance | ✅ PASS | No same-domain discordance; 2897 cross-domain discordant rows waived (v2 domain-specific extraction vs v1 keyword-matched comparison domain) |
...
| complications | discordant_existing | 3 | 2 | 0 | 3 |
| complications | existing_missing_fill_candidate | 274 | 250 | 0 | 0 |
...
| genetics | existing_missing_fill_candidate | 475 | 421 | 0 | 0 |
...
| operative_detail | existing_missing_fill_candidate | 1,269 | 784 | 0 | 0 |
| problem_list | concordant_existing_extraction_only | 252 | 167 | 0 | 0 |
| problem_list | source_limited | 110 | 93 | 0 | 0 |
| procedures | concordant_existing | 1,247 | 936 | 1,247 | 0 |
| procedures | concordant_existing_extraction_only | 17 | 10 | 0 | 0 |
| procedures | discordant_existing | 1,088 | 813 | 0 | 1,088 |
| procedures | existing_missing_fill_candidate | 45 | 43 | 0 | 0 |
| staging | concordant_existing | 903 | 754 | 903 | 0 |
| staging | discordant_existing | 1,011 | 653 | 0 | 1,011 |
...
- **Total rows needing review:** 5,326
  - Discordant (conflict): 2,897
  - Fill candidates: 2,429
...
cat studies/v2_domain_promotion_gate_promote_20260408_0407/promotion_scorecard.csv

# 2. (MotherDuck) Promote v2_stage -> main
# Review and paste: studies/v2_domain_promotion_gate_promote_20260408_0407/motherduck_promote.sql
