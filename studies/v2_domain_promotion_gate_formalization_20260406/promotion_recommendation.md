...
**Run label:** `formalization_20260406`  
**Generated at:** `2026-04-06T23:31:53.126731+00:00`  
**Overall verdict:** `FAIL` (3 of 8 gates failed)
...
| G3 | Provenance columns | ❌ FAIL | FAIL — no domain has provenance columns (('preprocess_batch_id', 'preprocess_script_version', 'preprocessed_at_utc')); fleet extraction must emit extracted_at and llm_model for traceability |
...
| G6 | Concordance floor (critical domains) | ❌ FAIL | Critical domains below 30% concordance: ['staging=21.7%'] |
...
| G8 | MotherDuck v2_stage parity | ❌ FAIL | Parity failures: ['v2_stage.note_entities_llm_us_nodule_dynamics', 'v2_stage.note_entities_llm_frozen_section_detail'] |
...
cat studies/v2_domain_promotion_gate_formalization_20260406/promotion_scorecard.csv

# 2. (MotherDuck) Promote v2_stage -> main
# Review and paste: studies/v2_domain_promotion_gate_formalization_20260406/motherduck_promote.sql
