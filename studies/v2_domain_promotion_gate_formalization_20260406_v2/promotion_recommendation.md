...
**Run label:** `formalization_20260406_v2`  
**Generated at:** `2026-04-06T23:34:57.021611+00:00`  
...
| G6 | Concordance floor (critical domains) | ❌ FAIL | Critical domains below 30% concordance: ['staging=21.7%']. Cross-domain keyword-matched entities may inflate denominators; review side-by-side for genuine extraction gaps. |
...
cat studies/v2_domain_promotion_gate_formalization_20260406_v2/promotion_scorecard.csv

# 2. (MotherDuck) Promote v2_stage -> main
# Review and paste: studies/v2_domain_promotion_gate_formalization_20260406_v2/motherduck_promote.sql
