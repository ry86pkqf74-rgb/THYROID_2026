...
| Specimen/FHIR QA diagnostics (142 views + focus checks) | FAIL | dup_master_fp=0, dup_focus_fp=None, orphan_focus=None, orphan_genomic(master/focus)=0/n/a, broken_fhir_refs=10139, prov_gaps(master/focus/high_tier_null_spec)=0/n/a/14 | NOTE: some focus-table scans unavailable on this catalog |
| Specimen-adjacent review burden (open/pending) | WARN | genomic_link_review open/pending=9952; merge queue: direct COUNT unavailable (MotherDuck/catalog — audit manually) |
