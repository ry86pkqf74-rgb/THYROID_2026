# Validation after diagnosis (production release-mode)

**Study:** `studies/specimen_fhir_blocker_20260408_074458/`  
**Context:** Read-only `119_md_formalization_validate.py --md --md-env prod --release-mode` after specimen/FHIR root-cause analysis. **Specimen Check 13:** PASS (clean `v_diag_*` surfaces on prod; `broken_fhir_refs=0`). Full report body below is the generated validator output.

---

# MotherDuck Formalization Release Validation Report

**Generated:** 2026-04-08T07:46:51.886932+00:00
