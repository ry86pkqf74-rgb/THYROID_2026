...
-- Domain: us_nodule_dynamics  qa_tier=standard
CREATE OR REPLACE TABLE main.note_entities_llm_us_nodule_dynamics AS
SELECT * FROM v2_stage.note_entities_llm_us_nodule_dynamics;
...
-- Domain: frozen_section_detail  qa_tier=standard
CREATE OR REPLACE TABLE main.note_entities_llm_frozen_section_detail AS
SELECT * FROM v2_stage.note_entities_llm_frozen_section_detail;
