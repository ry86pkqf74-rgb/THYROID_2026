-- mig_188 — mig_184_v2 R1 AJCC + r1c LN-only prior-thy carry-forward (Logan-ratified 2026-04-30)
...
-- Predecessor: mig_184_v2 (`9702290` / `184_v2_r1_ajcc_derivation_ratified_20260430.sql`)
...
FROM main.canonical_patient_master;
SELECT 'preexisting_mig188_registry_rows_same_batch' AS invariant_name, COUNT(*) AS observed_value, 0 AS expected_value
FROM main.canonical_column_verification_registry_v1
WHERE batch_id = 'mig_188_mig184_v2_plus_r1c_ln_only_stage_rule_apply_20260430';
...
SELECT
    ...
    'mig_188_mig184_v2_plus_r1c_ln_only_stage_rule_apply_20260430' AS batch_id,
    research_id,
    surgery_episode_id,
    tumor_ordinal,
    t_stage_ajcc7,
...
SET
    ...
    ajcc_resolution_source = 'mig188_mig184_v2_plus_r1c_ln_only_stage_rule_apply',
...
SET
    ...
    verified_by = 'mig_188_mig184_v2_plus_r1c_ln_only_stage_rule_apply_20260430',
    verified_ts = CAST(CURRENT_TIMESTAMP AS TIMESTAMP),
    verification_method = 'logan_ratified_AJCC8_R1_plus_r1c_prior_thy_carry_forward_legacy_columns_preserved',
    batch_id = 'mig_188_mig184_v2_plus_r1c_ln_only_stage_rule_apply_20260430',
    notes = COALESCE(notes, '') || ' | mig188+mig184_v2: CF-87-AJCC + r1c LN-only rule (prior_thy_recurrence_T_from_prior_path / unstaged / ambiguous_pm pending); manuscript SQL prefers *_resolved.'
WHERE notes ILIKE '%CF-87-AJCC%'
   OR notes ILIKE '%CF-87%AJCC%'
   OR batch_id ILIKE '%CF-87%';
...
VALUES
    ('mig_188_mig184_v2_plus_r1c_ln_only_stage_rule_apply_20260430', CAST(CURRENT_TIMESTAMP AS TIMESTAMP), CAST(CURRENT_TIMESTAMP AS TIMESTAMP),
     'pre_snapshot_add_resolved_cols_event_tnm_pm_stage_group_registry_provenance_r1c_prior_thy_rule',
     'CF-87-AJCC', 'r1c_residual_ln_only_prior_thy_rule', 'resolved_columns_authored', 'ambiguous_pm_size_only_logan_pending_csv');

-- §J Post-state probes — incl. new t_resolution_source values from §D-prime.
