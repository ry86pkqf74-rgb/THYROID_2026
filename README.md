...
|------|---------------------|----------|
| **A. Specimen + analytic FHIR (structural)** | Tables, QA views, and **`119 --release-mode` Check 13** can **PASS**; specimen merge/genomic linkage may still show **WARN** review burden | Latest rebaseline: [`studies/manuscript_blocker_rebaseline_20260408T073548Z/report.md`](studies/manuscript_blocker_rebaseline_20260408T073548Z/report.md) · Historical bundle: [`studies/specimen_fhir_release_truth_20260408T065318Z/`](studies/specimen_fhir_release_truth_20260408T065318Z/) |
| **B. MotherDuck manuscript / governance sign-off** | **`119`** can **PASS** with **0** pending MRQ and **0** synthetic placeholders while **99%+** of `qa.manual_review_queue` remains **`auto_accepted_*` (tier policy)** — **not** the same as clinician-reviewed decisions | MRQ truth + tiers: [`studies/manuscript_blocker_rebaseline_20260408T073548Z/review_queue_triage_20260408_073550/counts_manuscript_quality_tiers.csv`](studies/manuscript_blocker_rebaseline_20260408T073548Z/review_queue_triage_20260408_073550/counts_manuscript_quality_tiers.csv) · Hydrate path: [`docs/review_queue_triage_export.md`](docs/review_queue_triage_export.md) |
| **C. Institutional non-Tg labs** | **Wave present** on prod (`final_institutional_20260407`); **TSH/PTH/Ca/vitD** cover **hundreds of patients** vs **~3k** for structured Tg/TgAb — **source-limited** for population manuscripts; **free T4/T3, albumin, ionized Ca** etc. **not** in canonical layer yet | Same rebaseline `report.md` §3 · Scaffold: [`docs/lab_layer_scaffold_plan_20260313.md`](docs/lab_layer_scaffold_plan_20260313.md) |

**Current specimen + analytic FHIR / formalization truth (regenerate; do not trust stale copies):** [`studies/specimen_fhir_release_truth_20260408T065318Z/`](studies/specimen_fhir_release_truth_20260408T065318Z/) — `report.md`, `119_release_validation/validation_report.md`, and `motherduck_repo_state.md` from **`144 --md`** + **`119 --release-mode`** on catalog **`Thyroid 2026`**. Live row-count mirror: [`studies/CURRENT_MOTHERDUCK_REPO_STATE.md`](studies/CURRENT_MOTHERDUCK_REPO_STATE.md). Older lineage-audit tree (still useful for narrative): [`studies/20260407_live_truth_and_lineage_contract_audit/`](studies/20260407_live_truth_and_lineage_contract_audit/). Manuscript governance memos: [`studies/20260407_publication_signoff_live/`](studies/20260407_publication_signoff_live/). Early 20-check era snapshot: [`studies/20260407_formalization_validation_release_mode/`](studies/20260407_formalization_validation_release_mode/) — **history only**.

**Single-sentence release posture (2026-04-08 live rerun, rebaseline evidence pack):** **`119 --release-mode` = PASS WITH WARNINGS** (36 PASS / 3 WARN / 0 FAIL); **Check 13 (specimen + analytic FHIR)** has **no FAIL** (diagnostics clean; **WARN** on specimen-adjacent / genomic **review burden**). **Manuscript / governance** sign-off remains **materially short of “human-reviewed MRQ”** — live MRQ is almost entirely **`auto_accepted_*`** (see lens **B** above). **Institutional non-Tg** chemistry is **ingested but thin vs Tg/TgAb** (lens **C**) — not a missing-wave blocker, but a **coverage / extract-scope** limitation for non-Tg manuscript claims — see [`studies/manuscript_blocker_rebaseline_20260408T073548Z/report.md`](studies/manuscript_blocker_rebaseline_20260408T073548Z/report.md).

**Checked-in vs cloud manifests:** `exports/release_manifests/LATEST_MANIFEST.json` is a **point-in-time GitHub artifact** (e.g. March 2026 manuscript bundle). **Authoritative promotion history** for MotherDuck is `qa.release_manifest` on the live catalog (see `report.md` / `CURRENT_MOTHERDUCK_REPO_STATE.md` for latest tags).
...
| MotherDuck structure | **Formalized** — v2_stage ↔ main parity for **23** `canonical_output` domains; multiple `release_*` schemas; **`qa.release_manifest`** shows fresh tags through **20260408r3** (live 2026-04-08) plus earlier **20260411** row — confirm ordering with `144 --md` / `119 --release-mode` (see [`studies/specimen_fhir_release_truth_20260408T065318Z/report.md`](studies/specimen_fhir_release_truth_20260408T065318Z/report.md)) |
...
| Release-mode validation (latest live specimen/FHIR truth run) | [`studies/specimen_fhir_release_truth_20260408T065318Z/119_release_validation/`](studies/specimen_fhir_release_truth_20260408T065318Z/119_release_validation/) |
