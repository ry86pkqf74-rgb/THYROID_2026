...
**Single-sentence release posture (April 2026, post–live rerun):** **Technically passing but blocked by synthetic MRQ.** Concretely: latest committed **`119 --release-mode`** in [`studies/20260407_live_truth_and_lineage_contract_audit/119_release_validation/validation_report.md`](studies/20260407_live_truth_and_lineage_contract_audit/119_release_validation/validation_report.md) is **PASS WITH WARNINGS** (specimen/FHIR diagnostics do not FAIL; WARN on specimen-adjacent / genomic review burden). **Manuscript / governance** sign-off is **not** complete until MRQ + promotion decisions reflect **human-reviewed** paths (historical `--synthetic-fill-mrq-verification` and automation-only verification postures **do not** count as manuscript sign-off). An **earlier** same-day capture in [`studies/20260407_publication_signoff_live/validation_report.md`](studies/20260407_publication_signoff_live/validation_report.md) showed **BLOCKED** on specimen/FHIR — cite the **timestamped** artifact you mean. **Institutional non-Tg lab wave:** **closed** — `final_institutional_20260407` ingested via `127`; see [`studies/20260407_institutional_lab_wave_closeout/`](studies/20260407_institutional_lab_wave_closeout/) and operator evidence [`studies/20260411_final_master_release/EVIDENCE_PACK.md`](studies/20260411_final_master_release/EVIDENCE_PACK.md).
