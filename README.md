...
**Authoritative release-truth + live prod capture (specimen / FHIR writer UA v2):** [`studies/specimen_fhir_release_truth_20260408T122117Z/report.md`](studies/specimen_fhir_release_truth_20260408T122117Z/report.md) — **live** `Thyroid 2026` probe, row counts, `qa.release_manifest`, **Check 13** summary (2026-04-08), QA-vs-prod caveat, manifest lag vs `exports/release_manifests/LATEST_MANIFEST.json`. Operator-only prep: [`studies/specimen_fhir_release_truth_20260408T121042Z/report.md`](studies/specimen_fhir_release_truth_20260408T121042Z/report.md) (no live token session).

**Three different “ready” lenses (do not conflate):**

| Lens | What it means today | Evidence |
|------|---------------------|----------|
| **A. Specimen + analytic FHIR (structural)** | Tables, QA views, and **`119 --release-mode` Check 13** can **PASS**; specimen merge/genomic linkage may still show **WARN** review burden | **Live prod:** [`studies/specimen_fhir_release_truth_20260408T122117Z/report.md`](studies/specimen_fhir_release_truth_20260408T122117Z/report.md) · Manuscript-oriented rebaseline: [`studies/manuscript_blocker_rebaseline_20260408T073548Z/report.md`](studies/manuscript_blocker_rebaseline_20260408T073548Z/report.md) · **Superseded** historical bundles: [`studies/specimen_fhir_release_truth_20260408T065318Z/`](studies/specimen_fhir_release_truth_20260408T065318Z/), [`studies/specimen_fhir_release_truth_20260408T121042Z/`](studies/specimen_fhir_release_truth_20260408T121042Z/) |
...
| MotherDuck structure | **Formalized** — v2_stage ↔ main parity for **23** `canonical_output` domains; multiple `release_*` schemas; **`qa.release_manifest`** ordering is **live-only** — see [`studies/specimen_fhir_release_truth_20260408T122117Z/report.md`](studies/specimen_fhir_release_truth_20260408T122117Z/report.md) |
...
| FHIR specimen NDJSON export (de-identified bundles) | [`scripts/141_fhir_specimen_json_export.py`](scripts/141_fhir_specimen_json_export.py) → `exports/fhir_specimen_<UTC>/` (`specimen_bundles.ndjson`, `manifest.json`, `README.md`); prefers `main.fhir_bundle_specimen_export_v1`, else reconstructs from resource tables; UA `specimen_fhir_export_restore_v1` |
...
| Release-mode validation (specimen/FHIR; prod **2026-04-08**) | [`studies/specimen_fhir_release_truth_20260408T122117Z/119_release_validation_prod/`](studies/specimen_fhir_release_truth_20260408T122117Z/119_release_validation_prod/) · Report: [`studies/specimen_fhir_release_truth_20260408T122117Z/report.md`](studies/specimen_fhir_release_truth_20260408T122117Z/report.md) · Historical: [`studies/specimen_fhir_release_truth_20260408T065318Z/119_release_validation/`](studies/specimen_fhir_release_truth_20260408T065318Z/119_release_validation/) |
