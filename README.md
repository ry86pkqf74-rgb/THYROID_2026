...
**Single-sentence release posture (2026-04-08 live rerun):** **`119 --release-mode` = PASS WITH WARNINGS** (36 PASS / 3 WARN / 0 FAIL); **Check 13 (specimen + analytic FHIR)** has **no FAIL** (diagnostics clean; **WARN** on specimen-adjacent / genomic **review burden**, not on missing `v_diag_*`). **Manuscript / governance** sign-off remains **incomplete** until MRQ + promotion reflect **human-reviewed** paths (automation-only / synthetic verification does **not** count). **Institutional non-Tg lab wave** remains **closed** (`final_institutional_20260407` via `127`); residual gaps are **source-limited enrichment**, not a missing-wave blocker — see [`studies/20260407_institutional_lab_wave_closeout/`](studies/20260407_institutional_lab_wave_closeout/) and [`studies/20260411_final_master_release/EVIDENCE_PACK.md`](studies/20260411_final_master_release/EVIDENCE_PACK.md).
