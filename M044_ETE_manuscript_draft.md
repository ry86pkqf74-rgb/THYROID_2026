...
(McFadden pseudo-R²=0.1404; n=3750, path-proven events=193; likelihood-ratio χ²=213.65 vs intercept-only). A Cox proportional hazards model on the same strict-DTC subset (documented surgery date, positive follow-up; **no RAI covariate**; n=2511) estimated HR=0.91 (95% CI 0.48–1.73; p=0.774) for gross vs microscopic ETE.
