...
Gross vs microscopic ETE: adjusted OR 1.72 (95% CI 1.15–2.56; p=0.007617)

No/negative vs microscopic ETE: adjusted OR 0.55 (95% CI 0.23–1.32; p=0.1833)
...
(McFadden pseudo-R²=0.1460; n=3614, path-proven events=136; likelihood-ratio χ²=169.23 vs intercept-only). A Cox proportional hazards model on the same strict-DTC subset (documented surgery date, positive follow-up; **no RAI covariate**; n=2431) estimated HR=1.34 (95% CI 0.91–1.98; p=0.1411) for gross vs microscopic ETE.
